 ...
 */
 ...
 // 페이지 로딩 완료시 채팅창을 제일 밑으로 내리기
 // () 안에 익명함수를 만들고 다시 ()를 붙여야 실행됨
 // 즉시실행함수 => 속도가 빠르고, 변수명 중복문제해결, IIFE
 (
 	function(){
 ...
 function sendMessage(){
 	...
 	if(inputChatting.value.trim().length == 0 ){
 		...
 		// JSON.stringify(객체) : JSON <- js Object
 		
 		// chattingSock(웹소켓 객체)를 이용해서 메세지 보내기

...
public class BoardTypeInterceptor extends HandlerInterceptorAdapter{
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
		...
		//application scope에 boardTypeList가 있는지 체크, 없을경우 이를 조회하는 boardService메서드 호출 후 결과를 세팅
		
		// application scope 객체 가져오기
	...
	// postHandle 실행된 후 이동이 완료되고 afterCompletion이 실행되게 됨
